...
class ArrayEntryToken implements TokenInterface
{
     ...
     * Capped at 8. If argument implements \ArrayAccess without \Traversable,
     * then key token is restricted to ExactValueToken.
     *
    ...
    public function scoreArgument($argument)
    {
        ...
        $keyScores = array_map(array($this->key, 'scoreArgument'),
            array_keys($argument));
        $valueScores = array_map(array($this->value, 'scoreArgument'),
            $argument);
    ...
    {
        return $value instanceof TokenInterface ? $value
