...
class MethodProphecy
{
     ...
     *
     * @throws \Prophecy\Exception\Doubler\MethodNotFoundException If method
     *                                                             not found
     */
    public function __construct(
        ...
        if (!method_exists($double, $methodName)) {
            throw new MethodNotFoundException(sprintf(
                'Method `%s::%s()` is not defined.', get_class($double),
                $methodName
    ...
    {
        if ($this->voidReturnType) {
            throw new MethodProphecyException("The method \"$this->methodName\" has a void return type",
                $this);
        }
