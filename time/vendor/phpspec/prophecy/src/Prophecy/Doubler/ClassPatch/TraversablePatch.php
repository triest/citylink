 ...
 * Forces classes that implement interfaces, that extend Traversable to also
 * implement Iterator.
 *
...
{
    /**
     * Supports nodetree, that implement Traversable, but not Iterator or
     * IteratorAggregate.
     *
