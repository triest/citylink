...
final class StrictUnifiedDiffOutputBuilderTest extends TestCase
{
     ...
     */
    public function testOutputBuilding(
        string $expected,
        string $from,
        string $to,
        array $options
     ...
     */
    public function testBasicDiffGeneration(
        string $expected,
        string $from,
        string $to
    ): void {
     ...
     */
    public function testConfiguredDiffGeneration(
        string $expected,
        string $from,
        string $to,
        array $config = []
...
',
    ...
    public function provideInvalidConfiguration(): array
    {
        ...
        return [
            ...
            [
                ...
                'Option "toFileDate" must be a string or <null>, got "integer#'
                .$time.'".',
            ],
            [
                [],
     ...
     */
    public function testCommonLineThreshold(
        string $expected,
        string $from,
        string $to,
        int $threshold
...
',
     ...
     */
    public function testContextLineConfiguration(
        string $expected,
        string $from,
        string $to,
        int $contextLines,
        int $commonLineThreshold = 6
    ): void {
        $diff = $this->getDiffer([
            'fromFile'            => 'input.txt',
            'toFile'              => 'output.txt',
...
',
    ...
    /**
     * Returns a new instance of a Differ with a new instance of the class
     * (DiffOutputBuilderInterface) under test.
     *
     * @param array $options
     *
     * @return Differ
