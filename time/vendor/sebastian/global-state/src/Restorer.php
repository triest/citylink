...
class Restorer
{
    ...
    public function restoreFunctions(Snapshot $snapshot)
    {
        ...
        foreach (
            \array_diff($functions['user'], $snapshot->functions()) as $function
        ) {
    ...
    /**
     * Restores all static attributes in user-defined classes from this
     * snapshot.
     */
    public function restoreStaticAttributes(Snapshot $snapshot)
    {
        $current = new Snapshot($snapshot->blacklist(), false, false, false,
        ...
        foreach (
            $snapshot->staticAttributes() as $className => $staticAttributes
        ) {
