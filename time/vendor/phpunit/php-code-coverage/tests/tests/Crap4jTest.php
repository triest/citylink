...
class Crap4jTest extends TestCase
{
    public function testForBankAccountTest()
    {
        ...
        $this->assertStringMatchesFormatFile(
            ...
            $crap4j->process($this->getCoverageForBankAccount(), null,
                'BankAccount')
        );
    }
    ...
    public function testForFileWithIgnoredLines()
    {
        ...
        $this->assertStringMatchesFormatFile(
            ...
            $crap4j->process($this->getCoverageForFileWithIgnoredLines(), null,
    ...
    public function testForClassWithAnonymousFunction()
    {
        ...
        $this->assertStringMatchesFormatFile(
            ...
            $crap4j->process($this->getCoverageForClassWithAnonymousFunction(),
                null, 'CoverageForClassWithAnonymousFunction')
        );
    }
}
