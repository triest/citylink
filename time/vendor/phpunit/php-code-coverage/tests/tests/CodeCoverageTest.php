...
class CodeCoverageTest extends TestCase
{
    ...
    public function testCollect()
    {
        ...
        $this->assertEquals(
            [
                ...
                'BankAccountTest::testBalanceCannotBecomeNegative2' => ['size'   => 'unknown',
                                                                        'status' => null,
                ],
                'BankAccountTest::testDepositWithdrawMoney'         => ['size'   => 'unknown',
                                                                        'status' => null,
                ],
            ],
            $coverage->getTests()
    ...
    public function testAppendThrowsExceptionIfCoveredCodeWasNotExecuted()
    {
        ...
        $this->coverage->append($data, 'File1.php', true, $linesToBeCovered,
            $linesToBeUsed);
    }
