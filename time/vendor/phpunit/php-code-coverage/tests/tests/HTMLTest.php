...
class HTMLTest extends TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$TEST_REPORT_PATH_SOURCE = TEST_FILES_PATH.'Report'
    ...
    protected function tearDown()
    {
        ...
        $tmpFilesIterator = new \RecursiveIteratorIterator(
            new \RecursiveDirectoryIterator(self::$TEST_TMP_PATH,
    ...
    {
        $expectedFilesPath = self::$TEST_REPORT_PATH_SOURCE.DIRECTORY_SEPARATOR
    ...
    public function testForFileWithIgnoredLines()
    {
        ...
        $report = new Facade;
        $report->process($this->getCoverageForFileWithIgnoredLines(),
            self::$TEST_TMP_PATH);
    ...
    public function testForClassWithAnonymousFunction()
    {
        ...
        $report = new Facade;
        $report->process($this->getCoverageForClassWithAnonymousFunction(),
            self::$TEST_TMP_PATH);
    ...
    private function assertFilesEquals($expectedFilesPath, $actualFilesPath)
    {
        ...
        $actualFilesIterator
            = new \RegexIterator(new \FilesystemIterator($actualFilesPath),
            '/.html/');
