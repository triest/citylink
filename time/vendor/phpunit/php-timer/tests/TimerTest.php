...
final class TimerTest extends TestCase
{
    ...
    {
        $this->assertStringMatchesFormat('%f %s',
     ...
     */
    public function testCanFormatSinceStartOfRequestWhenRequestTimeIsNotAvailableAsFloat(
    ): void
    {
     ...
     * @backupGlobals enabled
     */
    public function testCannotFormatTimeSinceStartOfRequestWhenRequestTimeIsNotAvailable(
    ): void
    {
        if (isset($_SERVER['REQUEST_TIME_FLOAT'])) {
            unset($_SERVER['REQUEST_TIME_FLOAT']);
    ...
    {
        $this->assertStringMatchesFormat('Time: %s, Memory: %f %s',
            Timer::resourceUsage());
    }
     ...
     */
    public function testCanFormatSecondsAsString(
        string $string,
        float $seconds
    ): void {
     ...
     */
    public function testCanFormatBytesAsString(
        string $string,
        float $bytes
    ): void {
