...
class MockObjectTest extends TestCase
{
    ...
    public function testGetMockWithFixedClassNameCanProduceTheSameMockTwice()
    {
        $mock = $this->getMockBuilder(stdClass::class)
            ->setMockClassName('FixedName')->getMock();
        $mock = $this->getMockBuilder(stdClass::class)
            ->setMockClassName('FixedName')->getMock();
...
//            $this->fail('Expected exception');
    ...
    {
        $mock = $this->getMockBuilder(Foo::class)->setMethods(['bar'])
            ->getMock();
    ...
    public function testReturnTypesAreMockedCorrectly()
    {
        ...
        $this->assertInstanceOf(MockObject::class,
            $stub->methodWithClassReturnTypeDeclaration());
    }
    ...
    public function testObjectReturnTypeIsMockedCorrectly()
    {
        ...
        $this->assertInstanceOf(stdClass::class,
            $stub->methodWithObjectReturnTypeDeclaration());
    }
