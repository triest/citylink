...
class GeneratorTest extends TestCase
{
    ...
    {
        $mock
            = $this->generator->getMock(InterfaceWithSemiReservedMethodName::class);

        $this->assertTrue(method_exists($mock, 'unset'));
        $this->assertInstanceOf(InterfaceWithSemiReservedMethodName::class,
            $mock);
    }
    ...
    {
        $mock
            = $this->generator->getMockForAbstractClass(AbstractMockTestClass::class);
    ...
    public function testGetMockForAbstractClassExpectingInvalidArgumentException(
        ...
        $this->generator->getMockForAbstractClass($className, [],
            $mockClassName);
    }
    ...
    public function testExceptionIsRaisedForMutuallyExclusiveOptions()
    {
        ...
        $this->generator->getMock(stdClass::class, [], [], '', false, true,
            true, true, true);
    }
