...
class TestRunner extends BaseTestRunner
{
    ...
    public function doRun(
        ...
        if ($this->printer === null) {
            if (isset($arguments['printer'])
                ...
                $this->printer = new $printerClass(
                    (isset($arguments['stderr'])
                        && $arguments['stderr'] === true) ? 'php://stderr'
                        : null,
                    $arguments['verbose'],
                    $arguments['colors'],
                    $arguments['debug'],
        ...
        if ($codeCoverageReports > 0) {
            ...
            if (isset($arguments['configuration'])) {
                $filterConfiguration
                    = $arguments['configuration']->getFilterConfiguration();
                ...
                if (!empty($filterConfiguration['whitelist'])) {
                    ...
                    foreach (
                        $filterConfiguration['whitelist']['include']['file'] as
                        $file
                    ) {
                    ...
                    foreach (
                        $filterConfiguration['whitelist']['exclude']['file'] as
                        $file
                    ) {
            ...
            if (isset($arguments['coverageText'])) {
                if ($arguments['coverageText'] == 'php://stdout') {
                    ...
                    $colors = $arguments['colors']
                        && $arguments['colors'] != ResultPrinter::COLOR_NEVER;
                } else {
    ...
    protected function handleConfiguration(array &$arguments): void
    {
        ...
        if (isset($arguments['configuration'])) {
            ...
            $phpunitConfiguration
                = $arguments['configuration']->getPHPUnitConfiguration();
            ...
            if (isset($phpunitConfiguration['convertDeprecationsToExceptions'])
                && !isset($arguments['convertDeprecationsToExceptions'])
            ) {
                $arguments['convertDeprecationsToExceptions']
                    = $phpunitConfiguration['convertDeprecationsToExceptions'];
            }
            ...
            if (isset($phpunitConfiguration['ignoreDeprecatedCodeUnitsFromCodeCoverage'])
                && !isset($arguments['ignoreDeprecatedCodeUnitsFromCodeCoverage'])
            ) {
                $arguments['ignoreDeprecatedCodeUnitsFromCodeCoverage']
                    = $phpunitConfiguration['ignoreDeprecatedCodeUnitsFromCodeCoverage'];
            }
            ...
            if (isset($phpunitConfiguration['beStrictAboutResourceUsageDuringSmallTests'])
                ...
                $arguments['beStrictAboutResourceUsageDuringSmallTests']
                    = $phpunitConfiguration['beStrictAboutResourceUsageDuringSmallTests'];
            }
            ...
            if (isset($phpunitConfiguration['registerMockObjectsFromTestArgumentsRecursively'])
                ...
                $arguments['registerMockObjectsFromTestArgumentsRecursively']
                    = $phpunitConfiguration['registerMockObjectsFromTestArgumentsRecursively'];
            }
            ...
            $groupConfiguration
                = $arguments['configuration']->getGroupConfiguration();
            ...
            if (!empty($groupConfiguration['exclude'])
                ...
                $arguments['excludeGroups']
                    = \array_diff($groupConfiguration['exclude'],
                    $groupCliArgs);
            }

            foreach (
                $arguments['configuration']->getListenerConfiguration() as
                $listener
            ) {
            ...
            $loggingConfiguration
                = $arguments['configuration']->getLoggingConfiguration();
            ...
            if (isset($loggingConfiguration['testdox-xml'])
                ...
                $arguments['testdoxXMLFile']
                    = $loggingConfiguration['testdox-xml'];
            }

            $testdoxGroupConfiguration
                = $arguments['configuration']->getTestdoxGroupConfiguration();

            if (isset($testdoxGroupConfiguration['include'])
                && !isset($arguments['testdoxGroups'])
            ) {
                $arguments['testdoxGroups']
                    = $testdoxGroupConfiguration['include'];
            }
            ...
            if (isset($testdoxGroupConfiguration['exclude'])
                ...
                $arguments['testdoxExcludeGroups']
                    = $testdoxGroupConfiguration['exclude'];
            }
        }
        ...
        $arguments['beStrictAboutChangesToGlobalState']
            = $arguments['beStrictAboutChangesToGlobalState'] ?? null;
        $arguments['beStrictAboutResourceUsageDuringSmallTests']
            = $arguments['beStrictAboutResourceUsageDuringSmallTests'] ?? false;
        $arguments['cacheTokens'] = $arguments['cacheTokens'] ?? false;
        $arguments['colors'] = $arguments['colors'] ??
            ResultPrinter::COLOR_DEFAULT;
        $arguments['columns'] = $arguments['columns'] ?? 80;
        $arguments['convertDeprecationsToExceptions']
            = $arguments['convertDeprecationsToExceptions'] ?? true;
        $arguments['convertErrorsToExceptions']
        ...
        $arguments['disallowTestOutput'] = $arguments['disallowTestOutput'] ??
            false;
        $arguments['disallowTodoAnnotatedTests']
            = $arguments['disallowTodoAnnotatedTests'] ?? false;
        $arguments['enforceTimeLimit'] = $arguments['enforceTimeLimit'] ??
            false;
        $arguments['excludeGroups'] = $arguments['excludeGroups'] ?? [];
        $arguments['failOnRisky'] = $arguments['failOnRisky'] ?? false;
        $arguments['failOnWarning'] = $arguments['failOnWarning'] ?? false;
        $arguments['groups'] = $arguments['groups'] ?? [];
        $arguments['processIsolation'] = $arguments['processIsolation'] ??
            false;
        ...
        $arguments['reportLowUpperBound'] = $arguments['reportLowUpperBound'] ??
            50;
        $arguments['reportUselessTests'] = $arguments['reportUselessTests'] ??
            true;
        ...
        $arguments['stopOnIncomplete'] = $arguments['stopOnIncomplete'] ??
            false;
        ...
        $arguments['timeoutForLargeTests'] = $arguments['timeoutForLargeTests']
            ?? 60;
        $arguments['timeoutForMediumTests']
            = $arguments['timeoutForMediumTests'] ?? 10;
        $arguments['timeoutForSmallTests'] = $arguments['timeoutForSmallTests']
            ?? 1;
    ...
    private function processSuiteFilters(
        ...
        if (!$arguments['filter'] && empty($arguments['groups'])
