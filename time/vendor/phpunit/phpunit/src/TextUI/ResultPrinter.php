...
class ResultPrinter extends Printer implements TestListener
{
    ...
    public function startTestSuite(TestSuite $suite): void
    {
        if ($this->numTests == -1) {
            ...
            $this->maxColumn = $this->numberOfColumns - \strlen('  /  (XXX%)')
    ...
    protected function printFooter(TestResult $result): void
    {
        ...
        if ($result->wasSuccessful() && $result->allHarmless()
            ...
            $this->writeCountString($this->numAssertions, 'Assertions', $color,
                true);
            ...
            $this->writeCountString($result->notImplementedCount(),
                'Incomplete', $color);
