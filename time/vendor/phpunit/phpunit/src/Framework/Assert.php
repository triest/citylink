...
abstract class Assert
{
    ...
    public static function assertAttributeContains(
        ...
        static::assertContains(
            $needle,
            static::readAttribute($haystackClassOrObject,
    ...
    {
        static::assertThat($actual, static::logicalNot(static::isEmpty()),
            $message);
    }
    ...
    public static function assertLessThanOrEqual(
        ...
        static::assertThat($actual, static::lessThanOrEqual($expected),
            $message);
    }
    ...
    public static function assertDirectoryNotExists(
        ...
        static::assertThat($directory, new LogicalNot(new DirectoryExists),
            $message);
    }
    ...
    {
        static::assertThat($condition, static::logicalNot(static::isTrue()),
            $message);
    }
    ...
    public static function assertNotFalse(
        ...
        static::assertThat($condition, static::logicalNot(static::isFalse()),
            $message);
    }
    ...
    {
        static::assertThat($actual, static::logicalNot(static::isNull()),
            $message);
    }
    ...
    public static function assertClassHasAttribute(
        ...
        static::assertThat($className, new ClassHasAttribute($attributeName),
            $message);
    }
    ...
    /**
     * Assert that the size of two arrays (or `Countable` or `Traversable`
     * objects) is the same.
     *
    ...
    public static function assertStringMatchesFormat(
        ...
        static::assertThat($string, new StringMatchesFormatDescription($format),
            $message);
    }
    ...
    public static function assertJsonStringEqualsJsonString(
        ...
        static::assertThat($actualJson, new JsonMatches($expectedJson),
            $message);
    }
    ...
    public static function assertJsonFileNotEqualsJsonFile(
        ...
        static::assertThat($expectedJson, new LogicalNot($constraintActual),
            $message);
        static::assertThat($actualJson, new LogicalNot($constraintExpected),
            $message);
    }
    ...
    public static function contains(
        ...
        return new TraversableContains($value, $checkForObjectIdentity,
            $checkForNonObjectIdentity);
    }
    ...
    public static function containsOnlyInstancesOf(string $className
    ...
    public static function equalTo(
        ...
        return new IsEqual($value, $delta, $maxDepth, $canonicalize,
            $ignoreCase);
    }
    ...
    public static function classHasAttribute(string $attributeName
    ): ClassHasAttribute {
        return new ClassHasAttribute($attributeName);
    }

    public static function classHasStaticAttribute(string $attributeName
    ...
    public static function matchesRegularExpression(string $pattern
    ): RegularExpression {
        return new RegularExpression($pattern);
    }

    public static function matches(string $string
     ...
     * @return mixed
     */
    public static function getStaticAttribute(
        string $className,
        string $attributeName
    ) {
        if (!\class_exists($className)) {
