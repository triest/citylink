 ...
 *
 * Re-instantiates Exceptions thrown by user-space code to retain their
 * original
 * class names, properties, and stack traces (but without arguments).
 *
 * Unlike PHPUnit\Framework_\Exception, the complete stack of previous
 * Exceptions is processed.
 */
