...
EOF
    ...
    public function testConstraintFileNotExists(): void
    {
        $file = \dirname(__DIR__).DIRECTORY_SEPARATOR.'_files'
            .DIRECTORY_SEPARATOR.'ClassWithNonPublicAttributes.php';
...
EOF
    ...
    public function testConstraintGreaterThanOrEqual(): void
    {
        ...
        $this->assertEquals('is equal to 1 or is greater than 1',
            $constraint->toString());
...
EOF
    ...
    public function testConstraintNotGreaterThanOrEqual(): void
    {
        ...
        $this->assertEquals('not( is equal to 1 or is greater than 1 )',
            $constraint->toString());
        $this->assertCount(2, $constraint);
...
EOF
    ...
    public function testConstraintIsNotIdentical(): void
    {
        ...
        $this->assertEquals('is not identical to an object of class "stdClass"',
            $constraint->toString());
        $this->assertCount(1, $constraint);
...
EOF
    ...
    public function testConstraintIsInstanceOf(): void
    {
        ...
        $this->assertEquals('is instance of class "Exception"',
            $constraint->toString());
        $this->assertCount(1, $constraint);

        $interfaceConstraint = Assert::isInstanceOf(\Countable::class);
        $this->assertFalse($interfaceConstraint->evaluate(new \stdClass, '',
            true));
        $this->assertTrue($interfaceConstraint->evaluate(new \ArrayObject, '',
            true));
        $this->assertEquals('is instance of interface "Countable"',
...
EOF
    ...
    public function testConstraintIsNotInstanceOf(): void
    {
        ...
        $this->assertFalse($constraint->evaluate(new \stdClass, '', true));
        $this->assertTrue($constraint->evaluate(new Exception, '', true));
        $this->assertEquals('is not instance of class "stdClass"',
            $constraint->toString());
        $this->assertCount(1, $constraint);
...
EOF
    ...
    public function testConstraintLessThanOrEqual(): void
    {
        ...
        $this->assertEquals('is equal to 1 or is less than 1',
            $constraint->toString());
        $this->assertCount(2, $constraint);
...
EOF
    ...
    public function testConstraintNotLessThanOrEqual(): void
    {
        ...
        $this->assertFalse($constraint->evaluate(1, '', true));
        $this->assertEquals('not( is equal to 1 or is less than 1 )',
            $constraint->toString());
        $this->assertCount(2, $constraint);
...
EOF
    ...
    public function testConstraintClassNotHasAttribute(): void
    {
        ...
        $this->assertFalse($constraint->evaluate(\ClassWithNonPublicAttributes::class,
            '', true));
        $this->assertEquals('does not have attribute "privateAttribute"',
            $constraint->toString());
        $this->assertCount(1, $constraint);
...
EOF
    ...
    public function testConstraintClassNotHasStaticAttribute(): void
    {
        ...
        $this->assertFalse($constraint->evaluate(\ClassWithNonPublicAttributes::class,
            '', true));
        $this->assertEquals('does not have static attribute "privateStaticAttribute"',
            $constraint->toString());
        $this->assertCount(1, $constraint);
...
EOF
    ...
    public function testConstraintObjectNotHasAttribute(): void
    {
        ...
        $this->assertFalse($constraint->evaluate(new \ClassWithNonPublicAttributes,
            '', true));
        $this->assertEquals('does not have attribute "privateAttribute"',
            $constraint->toString());
        $this->assertCount(1, $constraint);
...
EOF
    ...
    public function testConstraintPCRENotMatch(): void
    {
        ...
        $this->assertEquals('does not match PCRE pattern "/foo/"',
            $constraint->toString());
        $this->assertCount(1, $constraint);
...
EOF
    ...
    public function testConstraintStringStartsNotWith(): void
    {
        ...
        $this->assertEquals('starts not with "prefix"',
            $constraint->toString());
        $this->assertCount(1, $constraint);
...
EOF
    ...
    public function testConstraintStringNotContainsWhenIgnoreCase(): void
    {
        ...
        $this->assertFalse($constraint->evaluate('oryginał', '', true));
        $this->assertEquals('does not contain "oryginał"',
            $constraint->toString());
...
EOF
    ...
    public function testAttributeNotEqualTo(): void
    {
        ...
        $this->assertEquals('attribute "foo" is not equal to 2',
            $constraint->toString());
        $this->assertCount(1, $constraint);
...
EOF
    ...
    public function testConstraintCountWithAnObjectImplementingCountable(): void
    {
        ...
        $this->assertFalse($constraint->evaluate(new \ArrayObject([1, 2, 3, 4]),
            '', true));
    }
