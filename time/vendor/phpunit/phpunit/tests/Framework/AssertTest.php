...
class AssertTest extends TestCase
{
    ...
    {
        $this->filesDirectory = \dirname(__DIR__).DIRECTORY_SEPARATOR.'_files'
            .DIRECTORY_SEPARATOR;
    }
    ...
    public function testAssertArraySubset(): void
    {
        ...
        $this->assertArraySubset(['a' => 'item a', 'c' => ['a2' => 'item a2']],
            $array);
        ...
        try {
            $this->assertArraySubset(['d' => ['a2' => ['bad index' => 'item b3']]],
                $array);
        } catch (AssertionFailedError $e) {
            return;
        }
    ...
    public function testAssertArraySubsetWithDeepNestedArrays(): void
    {
        ...
        $this->assertArraySubset(['path' => ['to' => ['the' => ['cake' => 'is a lie']]]],
            $array);

        $this->expectException(AssertionFailedError::class);

        $this->assertArraySubset(['path' => ['to' => ['the' => ['cake' => 'is not a lie']]]],
            $array);
    }
...
XML;
    ...
    public function testXMLStructureWrongNumberOfAttributes(): void
    {
        ...
        $actual = new \DOMDocument;
        $actual->load($this->filesDirectory
    ...
    {
        $this->assertDirectoryNotExists(__DIR__.DIRECTORY_SEPARATOR
            .'NotExisting');
    ...
    public function testAssertDirectoryIsReadable(): void
    {
        ...
        $this->assertDirectoryIsReadable(__DIR__.DIRECTORY_SEPARATOR
            .'NotExisting');
    }
    ...
    public function testAssertDirectoryIsWritable(): void
    {
        ...
        $this->assertDirectoryIsWritable(__DIR__.DIRECTORY_SEPARATOR
            .'NotExisting');
    }
    ...
    {
        $this->assertEquals('foo',
            $this->readAttribute(\ClassWithNonPublicAttributes::class,
    ...
    public function testGetObjectAttributeWorksForInheritedAttributes(): void
    {
        $this->assertEquals(
            'bar',
            $this->getObjectAttribute(new \ClassWithNonPublicAttributes,
    ...
    public function testAssertAttributeContainsNonObject(): void
    {
        ...
        $this->assertAttributeContains(true, 'privateArray', $obj, '', false,
            true, true);
    }
    ...
    public function testAssertAttributeNotContainsNonObject(): void
    {
        ...
        $this->assertAttributeNotContains(true, 'privateArray', $obj, '', false,
            true, true);
    ...
    {
        $this->assertAttributeEquals('foo', 'publicStaticAttribute',
            \ClassWithNonPublicAttributes::class);

        $this->expectException(AssertionFailedError::class);

        $this->assertAttributeEquals('bar', 'publicStaticAttribute',
            \ClassWithNonPublicAttributes::class);
    }

    public function testAssertPublicStaticAttributeNotEquals(): void
    {
        $this->assertAttributeNotEquals('bar', 'publicStaticAttribute',
            \ClassWithNonPublicAttributes::class);

        $this->expectException(AssertionFailedError::class);

        $this->assertAttributeNotEquals('foo', 'publicStaticAttribute',
            \ClassWithNonPublicAttributes::class);
    }

    public function testAssertProtectedStaticAttributeEquals(): void
    {
        $this->assertAttributeEquals('bar', 'protectedStaticAttribute',
            \ClassWithNonPublicAttributes::class);
    ...
    public function testAssertProtectedStaticAttributeNotEquals(): void
    {
        ...
        $this->assertAttributeNotEquals('bar', 'protectedStaticAttribute',
            \ClassWithNonPublicAttributes::class);
    }

    public function testAssertPrivateStaticAttributeEquals(): void
    {
        $this->assertAttributeEquals('baz', 'privateStaticAttribute',
            \ClassWithNonPublicAttributes::class);

        $this->expectException(AssertionFailedError::class);

        $this->assertAttributeEquals('foo', 'privateStaticAttribute',
            \ClassWithNonPublicAttributes::class);
    }

    public function testAssertPrivateStaticAttributeNotEquals(): void
    {
        $this->assertAttributeNotEquals('foo', 'privateStaticAttribute',
            \ClassWithNonPublicAttributes::class);

        $this->expectException(AssertionFailedError::class);

        $this->assertAttributeNotEquals('baz', 'privateStaticAttribute',
            \ClassWithNonPublicAttributes::class);
    }
    ...
    ): void
    {
        ...
        $this->assertClassHasAttribute('1',
            \ClassWithNonPublicAttributes::class);
    }
    ...
    ): void
    {
        ...
        $this->assertClassNotHasAttribute('1',
            \ClassWithNonPublicAttributes::class);
    }
    ...
    ): void
    {
        ...
        $this->assertClassHasStaticAttribute('1',
            \ClassWithNonPublicAttributes::class);
    }
    ...
    ): void
    {
        ...
        $this->assertClassNotHasStaticAttribute('1',
            \ClassWithNonPublicAttributes::class);
    }
    ...
    ): void
    {
        ...
        $this->assertObjectHasAttribute('1',
            \ClassWithNonPublicAttributes::class);
    }
    ...
    ): void
    {
        ...
        $this->assertObjectNotHasAttribute('1',
            \ClassWithNonPublicAttributes::class);
    }

    public function testClassHasPublicAttribute(): void
    {
        $this->assertClassHasAttribute('publicAttribute',
            \ClassWithNonPublicAttributes::class);

        $this->expectException(AssertionFailedError::class);

        $this->assertClassHasAttribute('attribute',
            \ClassWithNonPublicAttributes::class);
    }

    public function testClassNotHasPublicAttribute(): void
    {
        $this->assertClassNotHasAttribute('attribute',
            \ClassWithNonPublicAttributes::class);

        $this->expectException(AssertionFailedError::class);

        $this->assertClassNotHasAttribute('publicAttribute',
            \ClassWithNonPublicAttributes::class);
    }

    public function testClassHasPublicStaticAttribute(): void
    {
        $this->assertClassHasStaticAttribute('publicStaticAttribute',
            \ClassWithNonPublicAttributes::class);

        $this->expectException(AssertionFailedError::class);

        $this->assertClassHasStaticAttribute('attribute',
            \ClassWithNonPublicAttributes::class);
    }

    public function testClassNotHasPublicStaticAttribute(): void
    {
        $this->assertClassNotHasStaticAttribute('attribute',
            \ClassWithNonPublicAttributes::class);

        $this->expectException(AssertionFailedError::class);

        $this->assertClassNotHasStaticAttribute('publicStaticAttribute',
            \ClassWithNonPublicAttributes::class);
    }
    ...
    ): void
    {
        try {
            ...
            $this->assertEquals('Argument #2 (No Value) of PHPUnit\Framework\Assert::assertCount() must be a countable or iterable',
                $e->getMessage());
    ...
    ): void
    {
        try {
            ...
            $this->assertEquals('Argument #1 (No Value) of PHPUnit\Framework\Assert::assertSameSize() must be a countable or iterable',
                $e->getMessage());
    ...
    ): void
    {
        try {
            ...
            $this->assertEquals('Argument #2 (No Value) of PHPUnit\Framework\Assert::assertSameSize() must be a countable or iterable',
                $e->getMessage());
    ...
    public function testAssertJsonFileNotEqualsJsonFile(): void
    {
        ...
        $this->assertJsonFileNotEqualsJsonFile($fileExpected, $fileActual,
            $message);
    }
    ...
    {
        $this->assertStringMatchesFormatFile($this->filesDirectory
            .'expectedFileFormat.txt', "FOO\n");
    ...
    {
        $this->assertStringNotMatchesFormatFile($this->filesDirectory
            .'expectedFileFormat.txt', "BAR\n");
    ...
    protected function sameValues()
    {
        ...
        $file = \dirname(__DIR__).DIRECTORY_SEPARATOR.'_files'
    ...
    protected function notEqualValues()
    {
        ...
        return [
            ...
            [
                new \DateTime('2013-03-29 04:13:35',
                    new \DateTimeZone('America/New_York')),
                new \DateTime('2013-03-29 03:13:35',
                    new \DateTimeZone('America/New_York')),
            ],
            [
                new \DateTime('2013-03-29 04:13:35',
            ...
            [
                new \DateTime('2013-03-29 04:13:35',
                    new \DateTimeZone('America/New_York')),
                new \DateTime('2013-03-29 05:13:35',
                    new \DateTimeZone('America/New_York')),
                3500,
            ],
            [
    ...
    protected function equalValues()
    {
        ...
        return [
            ...
            [
                new \DateTime('2013-03-29 04:13:35',
                    new \DateTimeZone('America/New_York')),
                new \DateTime('2013-03-29 04:13:25',
                    new \DateTimeZone('America/New_York')),
                10,
            ],
            [
                new \DateTime('2013-03-29 04:13:35',
                    new \DateTimeZone('America/New_York')),
                new \DateTime('2013-03-29 04:14:40',
                    new \DateTimeZone('America/New_York')),
                65,
            ],
            [
            ...
            [
                new \DateTime('2013-03-29 04:13:35',
                    new \DateTimeZone('America/New_York')),
                new \DateTime('2013-03-29 03:13:49',
                    new \DateTimeZone('America/Chicago')),
                15,
            ],
            [
                new \DateTime('2013-03-30',
                    new \DateTimeZone('America/New_York')),
                new \DateTime('2013-03-29 23:00:00',
                    new \DateTimeZone('America/Chicago')),
            ],
            [
                new \DateTime('2013-03-30',
                    new \DateTimeZone('America/New_York')),
                new \DateTime('2013-03-29 23:01:30',
                    new \DateTimeZone('America/Chicago')),
                100,
            ],
            [
