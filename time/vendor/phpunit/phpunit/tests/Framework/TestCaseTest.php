...
class TestCaseTest extends TestCase
{
    ...
    public function testIncomplete(): void
    {
        ...
        $this->assertEquals(BaseTestRunner::STATUS_INCOMPLETE,
            $test->getStatus());
    ...
    public function testCurrentWorkingDirectoryIsRestored(): void
    {
        ...
        $test
            = new \ChangeCurrentWorkingDirectoryTest('testSomethingThatChangesTheCwd');
        $test->run();
