...
EOF;
    ...
    private const EXPECTREGEX_CONTENT
        = <<<EOF
--TEST--
EXPECTREGEX test
--FILE--
...
EOF
        ...
        $renderedCode = "<?php echo '".$this->dirname."' . '".$this->filename
            ."'; ?>".PHP_EOL;
    ...
    public function testRenderSkipifSection(): void
    {
        ...
        $renderedCode = "<?php echo 'skip: ' . '".$this->filename."'; ?>"
            .PHP_EOL;
