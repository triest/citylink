...
class XmlTest extends TestCase
{
    ...
    public function testPrepareString($char): void
    {
        ...
        $xml
            = "<?xml version='1.0' encoding='UTF-8' ?><tag>$escapedString</tag>";
    ...
    {
        $xml
            = '<array><element key="a"><array><element key="b"><string>foo</string></element></array></element><element key="c"><string>bar</string></element></array>';
        $dom = new \DOMDocument;
        $dom->loadXML($xml);
    ...
    {
        $xml
            = '<object class="SampleClass"><arguments><string>a</string><string>b</string><string>c</string></arguments></object>';
        $dom = new \DOMDocument();
        $dom->loadXML($xml);
    ...
    {
        $xml
            = '<object class="Exception"><arguments><string>one</string><integer>0</integer><object class="Exception"><arguments><string>two</string></arguments></object></arguments></object>';
        $dom = new \DOMDocument();
        $dom->loadXML($xml);
