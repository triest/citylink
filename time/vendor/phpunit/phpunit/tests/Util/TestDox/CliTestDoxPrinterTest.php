...
final class CliTestDoxPrinterTest extends TestCase
{
    ...
    public function testPrintsTheClassNameOfTheTestClass(): void
    {
        ...
        $this->assertStringStartsWith('PHPUnit\Util\TestDox\CliTestDoxPrinter',
    ...
    public function testPrintsThePrettifiedMethodName(): void
    {
        ...
        $this->assertContains('Prints the prettified method name',
            $this->printer->getBuffer());
    }
    ...
    public function testDoesNotPrintAdditionalInformationForSuccessfulTest(
    ): void
    {
        $this->printer->startTest($this);
        $this->printer->endTest($this, 0.001);
    ...
    public function testDoesNotPrintAdditionalInformationForIncompleteTestByDefault(
    ): void
    {
        $this->printer->startTest($this);
        $this->printer->addIncompleteTest($this, new Exception(), 0);
    ...
    public function testPrintsAdditionalInformationForIncompleteTestInVerboseMode(
    ): void
    {
        $this->verbosePrinter->startTest($this);
        $this->verbosePrinter->addIncompleteTest($this,
            new Exception('E_X_C_E_P_T_I_O_N'), 0);
        $this->verbosePrinter->endTest($this, 0.001);

        $this->assertContains('│', $this->verbosePrinter->getBuffer());
        $this->assertContains('E_X_C_E_P_T_I_O_N',
            $this->verbosePrinter->getBuffer());
    }
    ...
    public function testDoesNotPrintAdditionalInformationForRiskyTestByDefault(
    ): void
    {
        $this->printer->startTest($this);
        $this->printer->addRiskyTest($this, new Exception(), 0);
    ...
    public function testPrintsAdditionalInformationForRiskyTestInVerboseMode(
    ): void
    {
        $this->verbosePrinter->startTest($this);
    ...
    public function testDoesNotPrintAdditionalInformationForSkippedTestByDefault(
    ): void
    {
        $this->printer->startTest($this);
        $this->printer->addSkippedTest($this, new Exception(), 0);
    ...
    public function testPrintsAdditionalInformationForSkippedTestInVerboseMode(
    ): void
    {
        $this->verbosePrinter->startTest($this);
        $this->verbosePrinter->addSkippedTest($this,
            new Exception('S_K_I_P_P_E_D'), 0);
        $this->verbosePrinter->endTest($this, 0.001);

        $this->assertContains('│', $this->verbosePrinter->getBuffer());
        $this->assertContains('S_K_I_P_P_E_D',
            $this->verbosePrinter->getBuffer());
    }
}
