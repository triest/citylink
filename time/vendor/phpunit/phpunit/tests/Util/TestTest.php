...
class TestTest extends TestCase
{
    ...
    public function testGetExpectedException(): void
    {
        ...
        $this->assertArraySubset(
            ...
            Test::getExpectedException(\My\Space\ExceptionNamespaceTest::class,
                'testConstants')
        );
        ...
        $this->assertArraySubset(
            ...
            Test::getExpectedException(\ExceptionTest::class,
     ...
     * @throws \SebastianBergmann\RecursionContext\InvalidArgumentException
     */
    public function testGetRequirementsWithVersionConstraints(
        $test,
        array $result
    ): void {
    ...
    public function testGetRequirementsMergesClassAndMethodDocBlocks(): void
    {
        ...
        $this->assertEquals(
            $expectedAnnotations,
            Test::getRequirements(\RequirementsClassDocBlockTest::class,
                'testMethod')
        );
    }
    ...
    {
        $result = \preg_match(Test::REGEX_DATA_PROVIDER, '@dataProvider method',
            $matches);
        $this->assertEquals(1, $result);
        $this->assertEquals('method', $matches[1]);

        $result = \preg_match(Test::REGEX_DATA_PROVIDER,
            '@dataProvider class::method', $matches);
        $this->assertEquals(1, $result);
        $this->assertEquals('class::method', $matches[1]);

        $result = \preg_match(Test::REGEX_DATA_PROVIDER,
            '@dataProvider namespace\class::method', $matches);
        $this->assertEquals(1, $result);
        ...
        $result = \preg_match(Test::REGEX_DATA_PROVIDER, '@dataProvider メソッド',
            $matches);
        $this->assertEquals(1, $result);
    ...
    {
        $dataSets = Test::getProvidedData(\MultipleDataProviderTest::class,
            'testOne');
    ...
    {
        $dataSets
            = Test::getProvidedData(\VariousIterableDataProviderTest::class,
            'test');
    ...
    public function testParseAnnotation(): void
    {
        $this->assertEquals(
            ['Foo', 'ほげ'],
            Test::getDependencies(\get_class($this),
    ...
    public function getLinesToBeCoveredProvider()
    {
        return [
            ...
            [
                ...
                \array_merge(\range(23, 25), \range(27, 31), \range(33, 37),
                    \range(6, 8), \range(10, 13), \range(15, 18)),
            ],
            [
    ...
    {
        $result
            = Test::parseTestMethodAnnotations(\ParseTestMethodAnnotationsMock::class);
