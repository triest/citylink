...
class ExtensionTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(ApplicationName::class,
            $this->type->getApplicationName());
    }
    ...
    )
    {
        ...
        $extension = Type::extension($app,
            (new VersionConstraintParser)->parse('^1.0'));
