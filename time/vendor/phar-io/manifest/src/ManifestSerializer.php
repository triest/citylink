...
class ManifestSerializer
{
    ...
    public function serializeToString(Manifest $manifest)
    {
        ...
        $this->addContains($manifest->getName(), $manifest->getVersion(),
            $manifest->getType());
    ...
    private function addContains($name, Version $version, Type $type)
    {
        ...
        $this->xmlWriter->writeAttribute('version',
            ...
            case $type->isExtension():
                {
                    ...
                    $this->addExtension($type->getApplicationName(),
    ...
    private function addCopyright(CopyrightInformation $copyrightInformation)
    {
        ...
        foreach ($copyrightInformation->getAuthors() as $author) {
            ...
            $this->xmlWriter->writeAttribute('email',
    ...
    private function addBundles(
        ...
        foreach ($bundledComponentCollection as $bundledComponent) {
            ...
            $this->xmlWriter->writeAttribute('name',
    ...
    private function addExtension(
        ...
        $this->xmlWriter->writeAttribute('compatible',
