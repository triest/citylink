...
class ManifestElement
{
    ...
    {
        $element = $this->element->getElementsByTagNameNS(self::XMLNS,
            $elementName)->item(0);
    ...
    {
        $elementList = $this->element->getElementsByTagNameNS(self::XMLNS,
            $elementName);
    ...
    {
        return $this->element->getElementsByTagNameNS(self::XMLNS,
