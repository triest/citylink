...
final class TypeResolver
{
    ...
    /**
     * Initializes this TypeResolver with the means to create and resolve Fqsen
     * objects.
     *
     ...
     *
     * When a type is provided this method checks whether it is not a keyword
     * or
     ...
     *
     * @uses Context::getNamespace()        to determine with what to prefix
     *       the type name.
     * @uses Context::getNamespaceAliases() to check whether the first part of
     *       the relative type name should not be replaced with another
     *       namespace.
     *
     * @return Type|null
     */
    public function resolve($type, Context $context = null)
    {
        ...
        $type = trim($type);
        if (!$type) {
            throw new \InvalidArgumentException('Attempted to resolve "'.$type
    ...
    /**
     * Adds a keyword to the list of Keywords and associates it with a specific
     * Value Object.
     *
    ...
    public function addKeyword($keyword, $typeClassName)
    {
        if (!class_exists($typeClassName)) {
            throw new \InvalidArgumentException(
                ...
                .$keyword.'" must be an existing class'
    ...
    /**
     * Detects whether the given type represents a relative structural element
     * name.
     *
     * @param string $type A relative or absolute type as defined in the
     *                     phpDocumentor documentation.
    ...
    /**
     * Tests whether the given type is a Fully Qualified Structural Element
     * Name.
     *
     * @param string $type
     *
    ...
    /**
     * Resolves the given typed array string (i.e. `string[]`) into an Array
     * object with the right types set.
     *
     * @param string  $type
     * @param Context $context
     *
    ...
    /**
     * Resolves the given keyword (such as `string`) into a Type object
    ...
    /**
     * Resolves a compound type (i.e. `string|int`) into the appropriate Type
     * objects or FQSEN.
     *
     * @param string  $type
     * @param Context $context
