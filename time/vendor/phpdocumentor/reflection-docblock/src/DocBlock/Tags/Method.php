...
final class Method extends BaseTag implements Factory\StaticMethod
{
    ...
    public static function create(
        ...
        list(, $static, $returnType, $methodName, $arguments, $description)
            = $matches;
        ...
        if (is_string($arguments) && strlen($arguments) > 0) {
            ...
            foreach ($arguments as &$argument) {
                $argument = explode(' ', self::stripRestArg(trim($argument)),
                    2);
                if ($argument[0][0] === '$') {
                    $argumentName = substr($argument[0], 1);
                    $argumentType = new Void_();
                } else {
                    $argumentType = $typeResolver->resolve($argument[0],
                        $context);
                    $argumentName = '';
                    if (isset($argument[1])) {
        ...
        return new static($methodName, $arguments, $returnType, $static,
            $description);
    }
     ...
     *
     * @return bool TRUE if the method declaration is for a static method,
     *              FALSE otherwise.
     */
