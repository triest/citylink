...
final class DocBlockFactory implements DocBlockFactoryInterface
{
    ...
    /**
     * @param object|string $docblock A string containing the DocBlock to parse
     *                                or an object supporting the getDocComment
     *                                method (such as a ReflectionClass
     *                                object).
    ...
    public function create(
        ...
        return new DocBlock(
            $summary,
            $description ? $this->descriptionFactory->create($description,
                $context) : null,
            array_filter($this->parseTagBlock($tags, $context),
                function ($tag) {
     ...
     *
     * @author Richard van Velzen (@_richardJ) Special thanks to Richard for
     *         the regex responsible for the split.
     * @author Mike van Riel <me@mikevanriel.com> for extending the regex with
     *         template marker support.
     *
    ...
    private function filterTagBlock($tags)
    {
        ...
        if ('@' !== $tags[0]) {
            ...
            // we didn't foresee.
            throw new \LogicException('A tag block started with text instead of an at-sign(@): '
                .$tags);
